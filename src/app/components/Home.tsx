        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-8 md:px-24 w-full pt-32 md:pt-40">
          ...
          >
            ...
            <motion.p
              ...
              className="font-body text-xl md:text-2xl lg:text-3xl text-white font-semibold drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] mb-6 md:mb-16 leading-relaxed max-w-2xl text-left"
            >
