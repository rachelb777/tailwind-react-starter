      ...
      <section className="pt-24 pb-0 bg-background">
        <div className="max-w-[1600px] mx-auto px-8 lg:px-16">
          ...
          <div className="relative flex items-center justify-center" style={{height: "500px"}}>
            <motion.div initial={{opacity:0}} whileInView={{opacity:1}} viewport={{once:true}} transition={{duration:0.6}} className="absolute" style={{width:"280px", height:"280px", right:"calc(50% - 240px)", top:"20px"}}>
            ...
            <motion.div initial={{opacity:0}} whileInView={{opacity:1}} viewport={{once:true}} transition={{duration:0.6, delay:0.1}} className="absolute" style={{width:"220px", height:"220px", left:"calc(50% - 240px)", bottom:"20px"}}>
            ...
            <motion.div initial={{opacity:0}} whileInView={{opacity:1}} viewport={{once:true}} transition={{duration:0.6, delay:0.2}} className="absolute" style={{width:"250px", height:"250px", left:"calc(50% - 80px)", top:"60px"}}>
