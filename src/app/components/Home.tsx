        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-8 md:px-24 w-full pt-32 md:pt-40">
          ...
          >
            ...
            <motion.p
              ...
              className="font-body text-lg md:text-xl lg:text-2xl text-white font-semibold drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] mb-8 leading-relaxed max-w-2xl text-left"
            >
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-4 justify-start mt-12 md:mt-16"
            >
              <Link
                to="/morning"
