    ...
    <div className="relative">
      ...
      <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-start justify-start  overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img src={heroImage} alt="Person in field at sunset" className="w-full h-full object-center" />
        </div>
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-8 md:px-24 w-full pt-32 md:pt-40">
          ...
          >
            ...
            <motion.h2
              ...
              className="font-body text-xl md:text-2xl lg:text-3xl text-white font-semibold drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] mb-6 md:mb-16 leading-relaxed max-w-2xl text-left mt-6"
            >
              <span className="block pl-12">A free community resource</span>
              <span className="block pl-16">for holistic wellness</span>
            </motion.h2>
      ...
      <section id="how-solara-works" className="py-24 bg-background">
        <div className="max-w-[1100px] mx-auto px-8 lg:px-16">
          ...
          >
            ...
            <p className="font-body text-base md:text-lg text-foreground/80 leading-[2] max-w-3xl mx-auto text-left">
