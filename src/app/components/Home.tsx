      ...
      <section className="pt-24 pb-0 bg-background">
        <div className="max-w-[1600px] mx-auto px-8 lg:px-16">
          ...
          <div className="relative flex items-center justify-center" style={{ height: "680px" }}>
            ...
            <div className="absolute text-left" style={{ width: "180px", left: "calc(50% - 600px)", top: "110px" }}>
            ...
            <div className="absolute text-center" style={{ width: "220px", left: "calc(50% - 130px)", top: "480px" }}>
