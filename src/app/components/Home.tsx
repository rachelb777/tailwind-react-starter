      ...
      <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-start justify-start  overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-8 md:px-24 w-full pt-32 md:pt-40">
          <motion.div
            ...
            className="max-w-4xl text-left space-y-4"
          >
            <motion.h1
            ...
            <motion.p
              ...
              className="font-body text-lg md:text-xl lg:text-2xl text-white font-semibold drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] mb-10 leading-relaxed max-w-2xl text-left"
            >
