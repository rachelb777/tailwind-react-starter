        ...
        <div className="max-w-[1600px] mx-auto px-8 lg:px-16">
          ...
          >
            <div className="w-full">
              <video
                src="/videos/wellness-dashboard.mp4"
                controls
                preload="metadata"
                playsInline
            ...
            <div>
              ...
              <p className="font-body text-2xl text-foreground/70 max-w-2xl mx-auto text-left flex flex-col">
      ...
      <section className="px-8 lg:px-16 py-[60px]">
        ...
        >
          ...
          <p className="font-body text-foreground/80 leading-relaxed" style={{ fontSize: "20px" }}>
            See how each practice correlates with
            <br />
            your wellness measures over the past 14 days
          </p>
        </motion.div>
      </section>
