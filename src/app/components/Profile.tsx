      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="max-w-[1600px] mx-auto px-8 lg:px-16">
          ...
          >
            ...
            <h1 className="font-display text-6xl md:text-7xl text-foreground mb-4 leading-tight">
              Welcome Back
            </h1>
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      ...
                      <p className="font-body text-foreground/60">
                        Your wellness journey this week
                      </p>
                    </div>
                  ...
                  <div className="relative h-64 flex items-end justify-around gap-4 mb-6">
                    {weeklyProgress.map((day, index) => (
                      ...
                      >
                        <div className={`absolute inset-0 rounded-t-xl bg-gradient-to-t ${
                          day.completion === 100 ? 'from-primary to-secondary' :
                          day.completion >= 75 ? 'from-primary/80 to-secondary/80' :
                          day.completion >= 50 ? 'from-primary/60 to-secondary/60' :
                  ...
                  {todaysPractices.map((practice, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className={`font-body ${practice.completed ? 'text-foreground/60 line-through' : 'text-foreground'}`}>
                          {practice.name}
                        </div>
                      </div>
                  ...
                  {communityMembers.map((member, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-body text-foreground text-sm truncate">
                          {member.name}
                        </div>
