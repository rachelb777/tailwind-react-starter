        ...
        <nav className="max-w-[1600px] mx-auto px-8 lg:px-16">
          <div className="flex items-center justify-between h-24">
            ...
            <div className="flex items-center gap-6">
              ...
              {/* Member Login Button */}
              <button className="ml-4 px-6 py-2.5 bg-primary/90 text-primary-foreground rounded-full shadow-sm font-body text-[15px] hover:bg-primary/90 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center gap-2">
